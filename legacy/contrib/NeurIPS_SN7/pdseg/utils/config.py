...
########################## 数据集配置 #########################################
# 输入为 img + label or img1 + img2 + label or img1 + img2 + label1 + label2
...
# 图像随机旋转0-270度
cfg.AUG.RANDOM_ROTATION90 = False
...
# 测试模型路径
cfg.TEST.TEST_MODEL = ''
cfg.TEST.TEST_AUG = False
cfg.TEST.TEST_AUG_FLIP_OPS = [
    'horizontal', 'vertical', 'main_diagonal', 'back_diagonal'
]
cfg.TEST.TEST_AUG_ROTATE_OPS = [90, 180, 270]

########################## 可视化配置 ###########################################
cfg.VIS.ADD_LABEL = True
cfg.VIS.RAW_PRED = False
cfg.VIS.SEG_FOR_CD = False
cfg.VIS.VISINEVAL = False
